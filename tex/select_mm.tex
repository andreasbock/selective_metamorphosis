...
\cite{cotter2013bayesian}, see also \cite{schiratti2017bayesian} for similar Bayesian 
approaches in computational anatomy. The goal is to develop an algorithm to infer $\nu$,
