...
\begin{minipage}{\textwidth}
  \centering
    \includegraphics[width=.3\textwidth]{mm/mm_criss_cross.pdf}\quad
    %\includegraphics[width=.2\textwidth]{mm/mm_pringle.pdf}\quad
    \includegraphics[width=.3\textwidth]{mm/mm_squeeze.pdf}\quad
    \includegraphics[width=.3\textwidth]{mm/mm_triangle_flip.pdf}\\[0.25cm]
    \includegraphics[width=.3\textwidth]{lddmm/lddmm_criss_cross.pdf}\quad
    %\includegraphics[width=.2\textwidth]{lddmm/lddmm_pringle.pdf}\quad
