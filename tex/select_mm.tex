...
\begin{minipage}{\textwidth}
  \centering
  \subfigure{\includegraphics[scale=.3]{density_criss_cross.pdf}}
  \subfigure{\includegraphics[scale=.3]{centroid_heat_criss_cross.pdf}}
  \subfigure{\includegraphics[scale=.3]{functional_histogram_criss_cross.pdf}}
  \subfigure{\includegraphics[scale=.33]{autocorrelation_criss_cross.pdf}}
  \subfigure{\includegraphics[scale=.30]{MAP_center_criss_cross.pdf}}
...
\begin{minipage}{\textwidth}
  \centering
  \subfigure{\includegraphics[scale=.3]{density_squeeze.pdf}}
  \subfigure{\includegraphics[scale=.3]{centroid_heat_0_squeeze.pdf}}
  \subfigure{\includegraphics[scale=.3]{centroid_heat_1_squeeze.pdf}}
  \subfigure{\includegraphics[scale=.3]{functional_histogram_squeeze.pdf}}
  \subfigure{\includegraphics[scale=.31]{autocorrelation_squeeze.pdf}}
  \subfigure{\includegraphics[scale=.27]{MAP_center_squeeze.pdf}}
...
setting investigating a Metropolis-adjusted Langevin algorithm is also
